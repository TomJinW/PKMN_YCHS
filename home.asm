...
.printItemQuantity
	...
	push hl
	ld bc, 10 ; SCREEN_WIDTH + 8 ; 1 row down and 8 columns right
	add hl, bc
	ld a, "×"
	ld [hli], a
	ld a, [wd11e]
...
SaveScreenTilesToBuffer2::
	jpab _SaveScreenTilesToBuffer2
	; coord hl, 0, 0
...
LoadScreenTilesFromBuffer2DisableBGTransfer::
	jpab _LoadScreenTilesFromBuffer2DisableBGTransfer
	; xor a
	; ld [H_AUTOBGTRANSFERENABLED], a
...
SaveScreenTilesToBuffer1::
	jpab _SaveScreenTilesToBuffer1
	; coord hl, 0, 0
...
LoadScreenTilesFromBuffer1::
	jpab _LoadScreenTilesFromBuffer1
	; xor a
	; ld [H_AUTOBGTRANSFERENABLED], a
