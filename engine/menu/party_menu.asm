...
.skipUnfilledRightArrow
	...
	call PrintStatusCondition_PartyMenu
	pop hl
	push hl
	; ld bc, SCREEN_WIDTH + 1 ; down 1 row and right 1 column
	ld bc, 10 ; down 1 row and right 1 column
	; ld a, [hFlags_0xFFFA]
	; set 0, a
	; ld [hFlags_0xFFFA], a
	add hl, bc
...
.placeMoveLearnabilityString
	push hl
	ld bc, 10 ; 20 + 9 ; down 1 row and right 9 columns
	add hl, bc
	call PlaceString
	pop hl
.printLevel
